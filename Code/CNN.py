...
#print(x_train_positives.iloc[1].shape)
print(X_train.shape)
print(type(X_train))
for i in range(len(x_train_positives)):
...
#print(X_train[np.squeeze(y_train) == 1].shape)
#print(X_test[np.squeeze(y_train) == 0].shape)
...
#print(classification_report(y_t,model.predict(X_t)))